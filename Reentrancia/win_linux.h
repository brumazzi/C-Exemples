...
int start_window(x11_window win){
...
//	XGetWindowAttributes(win.dpy,win.root,&win.swa);

	win.win = XCreateWindow(win.dpy, win.root, 0, 0, 640, 480, 0, win.vi->depth, InputOutput, win.vi->visual,CWBorderPixel|CWColormap|CWEventMask|CWOverrideRedirect,&win.swa);
